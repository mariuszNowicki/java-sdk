...
public class Cache extends Connector {
	 ...
	 * fields for users.
	 */
	public Response getLeaderboardGroup(List<Long> groups, Long groupId,
			Long offset, Map<String, String> order, List<String> fields,
			List<Long> segments, Long leaderboardId, Long limit)
			throws Exception {
	 ...
	 */
	public Response getLeaderboardUserFriends(List<Long> groups, Long offset,
			Map<String, String> order, List<String> fields,
			List<Long> segments, Long leaderboardId, Long userId, Long limit)
			throws Exception {
	 ...
	 */
	public Response getLeaderboardSegment(Long segmentId, List<Long> groups,
			Long offset, Map<String, String> order, List<String> fields,
			List<Long> segments, Long leaderboardId, Long limit)
			throws Exception {
	 ...
	 */
	public Response getLeaderboard(List<Long> groups, Long offset,
			Map<String, String> order, List<String> fields,
			List<Long> segments, Long leaderboardId, Long limit)
			throws Exception {
	 ...
	 */
	public Response getLeaderboards(List<Long> groups, Long offset,
			Map<String, String> order, List<String> fields,
	 ...
	 */
	public Response getGames(Long offset, Map<String, String> order,
	 ...
	 */
	public Response getAchievementSegments(Long offset,
			Map<String, String> order, List<String> fields, Long achievementId,
	 ...
	 */
	public Response getAchievements(Long offset, Map<String, String> order,
			List<String> fields, List<Long> segments, Long limit)
			throws Exception {
	 ...
	 */
	public Response getStatistics(Long offset, Long limit, List<String> fields,
	 ...
	 * games list.
	 */
	public Response getUserGroupGames(Long groupId, Long offset,
			Map<String, String> order, List<String> fields,
			List<Long> segments, Long limit) throws Exception {
	 ...
	 * user group.
	 */
	public Response getUserGroupMembers(List<Long> groups, Long groupId,
			Long offset, Map<String, String> order, List<String> fields,
			List<Long> segments, Long limit) throws Exception {
	...
	public Response getUserGroupByExternalId(Long groupId,
			String externalIdName, String externalId, List<String> fields)
			throws Exception {
	...
	public Response getUserGroupSegments(Long groupId, Long offset,
			Map<String, String> order, List<String> fields, Long limit)
			throws Exception {
	 ...
	 */
	public Response getGroup(Long groupId, List<String> fields)
			throws Exception {
	 ...
	 */
	public Response getGroups(Long offset, Long limit, List<String> fields,
			Map<String, String> order) throws Exception {
	 ...
	 * achievements list.
	 */
	public Response getUserAchievements(Long offset, Map<String, String> order,
			List<String> fields, List<Long> segments, Long userId, Long limit)
			throws Exception {
	 ...
	 */
	public Response getUserGames(Long offset, Map<String, String> order,
			List<String> fields, List<Long> segments, Long userId, Long limit)
			throws Exception {
	 ...
	 */
	public Response getUserSegments(Long offset, Map<String, String> order,
			List<String> fields, Long userId, Long limit) throws Exception {
	 ...
	 */
	public Response getUserFriends(List<Long> groups, Long offset,
			Map<String, String> order, List<String> fields,
			List<Long> segments, Long userId, Long limit) throws Exception {
	 ...
	 */
	public Response getUserHistory(Long offset, Map<String, String> order,
			List<String> fields, Long userId, Long limit) throws Exception {
	 ...
	 */
	public Response getUser(Long userId, List<String> fields) throws Exception {
	 ...
	 */
	public Response getSegments(Long offset, Long limit, List<String> fields,
			Map<String, String> order) throws Exception {
	 ...
	 */
	public Response getEvent(String eventId, List<String> fields)
			throws Exception {
