...
public class Admin extends Connector {
	 ...
	 * id.
	 */
	public Response getFunction(Long functionId, String fields)
			throws Exception {
		Map<String, Object> array = new HashMap<String, Object>();
		array.put("functionId", functionId);
	 ...
	 */
	public Response getFunctions(String fields, Long offset, Long limit,
	 ...
	 * type.
	 */
	public Response getNotificationType(Long typeId, String fields)
			throws Exception {
		Map<String, Object> array = new HashMap<String, Object>();
		array.put("typeId", typeId);
		array.put("fields", fields);
	 ...
	 * types.
	 */
	public Response getNotificationTypes(String fields, Long offset,
			Long limit, String order) throws Exception {
		Map<String, Object> array = new HashMap<String, Object>();
		array.put("fields", fields);
		array.put("offset", offset);
		array.put("limit", limit);
	 ...
	 */
	public Response getNotifications(String fields, Long offset, Long limit,
			String order) throws Exception {
		Map<String, Object> array = new HashMap<String, Object>();
		array.put("fields", fields);
		array.put("offset", offset);
	...
	public Response getAchievementsDoc() throws Exception {
		...
		return this.callService("/admin/achievements/doc", "get", array, null);
	}
	 ...
	 * achievement group.
	 */
	public Response getAchievementsGroup(Long achievementGroupId, String fields)
			throws Exception {
		Map<String, Object> array = new HashMap<String, Object>();
		array.put("achievementGroupId", achievementGroupId);
		array.put("fields", fields);
	 ...
	 * groups.
	 */
	public Response getAchievementsGroups(String fields, String order,
	 ...
	 * list.
	 */
	public Response getAchievementsProgresses(String fields, String order,
			Long offset, Long limit) throws Exception {
		Map<String, Object> array = new HashMap<String, Object>();
		array.put("fields", fields);
		array.put("order", order);
	 ...
	 */
	public Response getAchievements(String groups, Long offset, String order,
	 ...
	 */
	public Response getGames(String fields, Long offset, Long limit,
			String order) throws Exception {
		Map<String, Object> array = new HashMap<String, Object>();
		array.put("fields", fields);
		array.put("offset", offset);
	 ...
	 */
	public Response getLeaderboard(Long leaderboardId, String fields)
			throws Exception {
		Map<String, Object> array = new HashMap<String, Object>();
		array.put("leaderboardId", leaderboardId);
		array.put("fields", fields);
	 ...
	 */
	public Response getLeaderboards(String fields, Long offset, Long limit,
			String order) throws Exception {
		Map<String, Object> array = new HashMap<String, Object>();
		array.put("fields", fields);
		array.put("offset", offset);
	...
	public Response getStatisticsDocs() throws Exception {
		...
		return this.callService("/admin/statistics/doc", "get", array, null);
	}
	...
	public Response putStatistics(JSONObject body) throws Exception {
		...
		return this.callService("/admin/statistics", "put", array, body);
	}
	 ...
	 * being tested.
	 */
	public Response getStatistics(String fields, Long offset, Long limit,
			String order) throws Exception {
		Map<String, Object> array = new HashMap<String, Object>();
		array.put("fields", fields);
		array.put("offset", offset);
	 ...
	 */
	public Response getTransactionSource(Long transactionSourceId, String fields)
			throws Exception {
		Map<String, Object> array = new HashMap<String, Object>();
		array.put("transactionSourceId", transactionSourceId);
		array.put("fields", fields);
	 ...
	 * sources.
	 */
	public Response getTransactionSources(String fields, Long offset,
			Long limit, String order) throws Exception {
		Map<String, Object> array = new HashMap<String, Object>();
		array.put("fields", fields);
		array.put("offset", offset);
	 ...
	 */
	public Response getUserGroupGainedAchievements(Long offset, String order,
			Long userGroupId, String fields, Long limit) throws Exception {
		Map<String, Object> array = new HashMap<String, Object>();
		array.put("offset", offset);
		array.put("order", order);
		array.put("userGroupId", userGroupId);
	 ...
	 * of external ids.
	 */
	public Response getUserGroupExternalIds(Long offset, String order,
			Long userGroupId, String fields, Long limit) throws Exception {
		Map<String, Object> array = new HashMap<String, Object>();
		array.put("offset", offset);
		array.put("order", order);
	 ...
	 */
	public Response getUserGroupCounterValues(Long offset, String order,
			Long userGroupId, String fields, Long limit) throws Exception {
		Map<String, Object> array = new HashMap<String, Object>();
		array.put("offset", offset);
		array.put("order", order);
	 ...
	 */
	public Response getUserGroupWonGames(Long offset, String order,
			Long userGroupId, String fields, Long limit) throws Exception {
		Map<String, Object> array = new HashMap<String, Object>();
		array.put("offset", offset);
		array.put("order", order);
	 ...
	 */
	public Response getUserGainedAchievements(Long offset, String order,
			String fields, Long userId, Long limit) throws Exception {
		Map<String, Object> array = new HashMap<String, Object>();
		array.put("offset", offset);
		array.put("order", order);
		array.put("fields", fields);
	 ...
	 * ids.
	 */
	public Response getUserExternalIds(Long offset, String order,
			String fields, Long userId, Long limit) throws Exception {
		Map<String, Object> array = new HashMap<String, Object>();
		array.put("offset", offset);
		array.put("order", order);
	 ...
	 */
	public Response getUserCounterValues(Long offset, String order,
			String fields, Long userId, Long limit) throws Exception {
		Map<String, Object> array = new HashMap<String, Object>();
		array.put("offset", offset);
		array.put("order", order);
	 ...
	 * for a user.
	 */
	public Response getUserWonGames(Long offset, String order, String fields,
	 ...
	 */
	public Response getClientScript(Long clientScriptId, String fields)
			throws Exception {
		Map<String, Object> array = new HashMap<String, Object>();
		array.put("clientScriptId", clientScriptId);
		array.put("fields", fields);
	 ...
	 */
	public Response getClientScripts(String fields, String order, Long offset,
	 ...
	 */
	public Response getSegments(String fields, Long offset, Long limit,
			String order) throws Exception {
		Map<String, Object> array = new HashMap<String, Object>();
		array.put("fields", fields);
		array.put("offset", offset);
	 ...
	 * id.
	 */
	public Response getCondition(Long conditionId, String fields)
			throws Exception {
		Map<String, Object> array = new HashMap<String, Object>();
		array.put("conditionId", conditionId);
		array.put("fields", fields);
	 ...
	 */
	public Response getConditions(String fields, Long offset, Long limit,
			String order) throws Exception {
		Map<String, Object> array = new HashMap<String, Object>();
		array.put("fields", fields);
		array.put("offset", offset);
